...
boy = createSprite(70,windowHeight-100,20,20);
...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Tesouro: "+ treasureCollection,windowWidth-130,30);
  }
...
function createCash() {
  ...
  var cash = createSprite(Math.round(random(50, 350),windowHeight-10, 10, 10));
